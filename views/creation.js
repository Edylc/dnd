...
var spy = new Background('Criminal (Spy)', ['Deception', 'Stealth'], ['Gaming set', 'thieves\' tools'], [], ['Crowbar', 'Dark common clothes w/ hood', 'Belt pouch'], 15, 'Spy Contact');
...
var gladiator = new Background('Entertainer (Gladiator)', ['Acrobatics', 'Performance'], ['Disguise kit', 'Musical instrument'], [], ['Inexpensive but unusual weapon', 'Admirer\'s favor', 'Costume', 'Belt pouch'], 15, 'By Popular Demand');
...
var cleric = new Class('Cleric', ['Spellcasting', 'Divine Domain'], 3, 0, 2, new Roll(4, 5, 0, 10), new Roll(8, 1), ['light', 'medium', 'shields', 'simple'], ['None'], ['Wisdom', 'Charisma'], 2, [hist, insight, medicine, persuasion, religion]);
...
var fighter = new Class('Fighter', ['Fighting Style', 'Second Wind'], 0, 0, 0, new Roll(4, 5, 0, 10), new Roll(10, 1), ['light', 'medium', 'heavy', 'shields', 'simple', 'martial'], ['None'], ['Strength', 'Constitution'], 2, [acrobatics, animal, athletics, hist, insight, intimidation, perception, survival]);
var monk = new Class('Monk', ['Unarmored Defense', 'Martial Arts'], 0, 0, 0, new Roll(4, 5, 0, 1), new Roll(8, 1), ['simple', 'shortsword'], ['Artisan\'s tools or Musical instrument'], ['Strength', 'Dexterity'], 2, [acrobatics, athletics, hist, insight, religion, stealth]);
...
var warlock = new Class('Warlock', ['Pact Magic', 'Otherworldly Patron'], 2, 2, 1, new Roll(4, 4, 0, 10), new Roll(8, 1), ['light', 'simple'], ['None'], ['Wisdom', 'Charisma'], 2, [arcana, deception, hist, intimidation, investigation, nature, religion]);
var wizard = new Class('Wizard', ['Arcane Recovery', 'Spellcasting'], 3, 0, 2, new Roll(4, 4, 0, 10), new Roll(6, 1), ['dagger', 'dart', 'sling', 'quarterstaff', 'light crossbow'], ['None'], ['Intelligence', 'Wisdom'], 2, [arcana, hist, insight, investigation, medicine, religion]);
...
var half_orc = new Race('Half-Orc', 'Medium', [2, 0, 1, 0, 0, 0], ['Common', 'Orc'], ['Darkvision', 'Menacing', 'Relentless Endurance', 'Savage Attacks']);
...
var mountain_dwarf = new Race('Dwarf (Mountain)', 'Medium', [2, 0, 2, 0, 0, 0], ['Common', 'Dwarvish'], ['Speed', 'Darkvision', 'Dwarven Resilience', 'Dwarven Combat Training', 'Tool Proficiency', 'Stonecunning', 'Dwarven Armor Training']);
